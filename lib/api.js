    ...
    const data = await fetchAPI(
        ...
        fragment PostFields on Post {
            ...
            productReviewFields {
                ...
                productPriceLinks {
                    __typename
                    ... on Post_Productreviewfields_ProductPriceLinks_ProductPriceLinks {
                        __typename
                        amazonProductId
                        bestBuyProductId
                        others {
                            __typename
                            ... on Post_Productreviewfields_ProductPriceLinks_ProductPriceLinks_others {
                                url
                                elementSelector
                            }
                        }
                ...
                specifications {
                    __typename
                    ... on Post_Productreviewfields_specifications {
                        specification {
                            __typename
                            ... on Post_Productreviewfields_specifications_Specification_Specification {
                                name
                                value
                            }
                        }
