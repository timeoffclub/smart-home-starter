        ...
        <>  
            {!featuredArticle ?
                ...
                <div className='container mb-12'>
                    <div className='block lg:grid grid-cols-1 lg:grid-cols-4 lg:gap-5 px-6 xl:px-12 2xl:px-0 '>
                    ...
                    <div className='hidden sm:grid px-6 xl:px-12 2xl:px-0 sm:grid-cols-2 lg:grid-cols-4 lg:min-h-[300px]  gap-5 mt-5'>
                    ...
                    <div className='md:hidden flex px-6 xl:px-12 2xl:px-0 flex-col justify-between col-span-2'>
                        {myArticles.slice(5,14).map((el, index) => (
                            <div key={el.id} className='flex items-center mb-3 lg:mb-0'>
                                {el.featuredImage &&
                                    <Link href={`/${el.slug}`}>
                                        <a className='relative shrink-0 h-24 w-24'>
                                            <Image 
                                                className='transition-all ease-in duration-500'
                                                src={el.featuredImage.node.sourceUrl}
                                                alt={el.featuredImage.node.altText}
                    ...
                    <div className='lg:grid px-6 xl:px-12 2xl:px-0 lg:grid-cols-4 gap-5 mt-5'>
                        ...
                        <div className='lg:hidden grid grid-cols-2 gap-5'>
                            {myArticles.slice(18,20).map((el) => (
                                <div key={el.id} className='col-span-2  sm:col-span-1 inline-flex flex-wrap sm:w-72 md:w-full mb-5'>
                                    {el.featuredImage &&
                                        <Link href={`/${el.slug}`}>
                                            <a className='relative w-full h-48 mb-3'>
                                                <Image 
                                                    src={el.featuredImage.node.sourceUrl}
                                                    alt={el.featuredImage.node.altText}
                                                    objectFit='cover'
