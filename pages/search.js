...
export default function Search({ data, nav, slug }) {
    ...
    return (
        <>
            ...
            <div className='flex justify-center px-6 xl:px-28 2xl:px-0  my-12'>
                <SearchForm
            ...
            :
                <>
                    <div className='container mb-12'>
                        ...
                        <div className='grid grid-cols-1 px-6 xl:px-28 2xl:px-0 sm:grid-cols-2 lg:grid-cols-4 gap-5'>
